...
# assigning objects representing hurricane start and finish
hurricane_start_1 <- "1989-09-18"
hurricane_start <- as.Date(hurricane_start_1)
hurricane_end_1 <- "1989-09-22"
hurricane_end <- as.Date(hurricane_end_1)


gage_plot <- ggplot(gage_df, aes(x = date, y = gage_ht)) +
  geom_rect(aes(xmin = hurricane_start,
                xmax = hurricane_end,
                ymin = 0,
                ymax = 12), fill = "blue") +
  geom_line(aes(color = sample_id)) +
