...
- ### Daniel created our final visualization, Halina documented our workflow and how we set up the project, and Peter created the rmarkdown presentation, and detailed our group roles
...
```{r, echo = FALSE}
knitr::include_graphics("figs/sio2_plot.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("figs/gage_plot.png")
```
